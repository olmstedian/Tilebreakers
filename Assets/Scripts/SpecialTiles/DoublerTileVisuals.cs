...
/// <summary>
/// Handles the visual elements of the DoublerTile, creates a dynamic sprite with "x2" marking.
/// </summary>
public class DoublerTileVisuals : MonoBehaviour
{
    [SerializeField] private Color tileColor = new Color(1f, 0.8f, 0.2f); // Bright gold/yellow
    [SerializeField] private Color symbolColor = new Color(1f, 1f, 1f);   // White for the "×2" text
    ...
    private void CreateSymbolText()
    {
        ...
        GameObject textObj = new GameObject("DoublerSymbol");
        ...
        symbolText.text = "×2"; // Unicode multiplication symbol with 2
    ...
    /// <summary>
    /// Performs a highlight animation for when the doubler tile is activated.
    /// </summary>
